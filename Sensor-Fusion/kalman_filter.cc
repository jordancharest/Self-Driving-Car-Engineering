...
int main() {
//  // you can create a  vertical vector of two elements with a command like
//  // this
//  VectorXd my_vector(2);
//  // you can use the so called comma initializer to set all the coefficients
//  // to some values
//  my_vector << 10, 20;
//
//
...
//
//
//  // you can use the same comma initializer or you can set each matrix value
//  // explicitly. For example that's how we can change the matrix elements in
//  // the second row
...
//
//
//  // Also, you can compute the transpose of a matrix with the following 
//  // command
...
//
//
//  // For multiplying the matrix m with the vector b you can write this in one
//  // line as let’s say matrix c equals m times v.
//  //
...
void filter(Eigen::VectorXd& x, Eigen::MatrixXd& P) {
  ...
  for (size_t n = 0; n < measurements.size(); ++n) {
    ...
    Eigen::VectorXd y = z.transpose() - (H * x);
